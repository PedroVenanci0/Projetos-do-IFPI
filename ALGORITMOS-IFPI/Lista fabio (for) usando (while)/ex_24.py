...
""")
    ...
    while contador_verificacao <= numero_de_habitantes:

        print(f"""
===========================
  >> HABITANTE N° {contador_verificacao} <<
===========================
""")
...
- MEDIA DE SALARIO DOS HABITANTES        >>> \033[32m{media_salarios:.0f} R$\033[m  
- MEDIA DE FILHOS DOS HABITANTES         >>> \033[30m{media_filhos:.1f}\033[m  
