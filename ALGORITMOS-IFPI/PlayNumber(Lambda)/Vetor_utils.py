...
import random
import os
from utils import myReduce,myfilter,myMap
...
def SomatorioValores(valores):
    ...
    somatorio = myReduce(lambda x,y: x + y, valores)
...
def QtdValoresPositivos(valores):
    ...
    ListaPositivos = myfilter(lambda x: x > 0, valores)
...
|Quantidade de Valores Positivos>> {contadorPositivos}|
======================
""")
...
def QtdValoresNegativos(valores):
    ...
    ListaNegativos = myfilter(lambda x: x < 0, valores)
...
def MultiplicarValores(valores):
    ...
    valores = myMap(lambda x: x * valor, valores)
...
def ReduzirAhFracao(valores):
    ...
    valores = myMap(lambda x: x * resultadoDivisao, valores)
